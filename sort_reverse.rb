...
# Re-run 2026-08-06 — Ruby 4.0.6 (no YJIT), ActiveSupport 8.1.3.1, benchmark-ips 2.15.1: sort.reverse still fastest at every size (10/100/1000); sort_by{-_1} still beats sort_by(&:-@)
TIMES = [10, 100, 1_000]
